...
void Steering_engine::run()
{
	...
	while(!PX4_OK)
	{
		...
		_actuators2.control[4] = (rpm_value_set-1500)/500;
		_actuators2.control[5] = (rpm_value_set-1500)/500;
		_actuators2.control[6] = (rpm_value_set-1500)/500;
		_actuators2.control[7] = (rpm_value_set-1500)/500;
